...
public class TopChurnByReleaseView extends ViewImpl implements TopChurnByReleasePresenter.MyView {
    ...
    @Inject
    public TopChurnByReleaseView(CodeHeatmapResources resources) {
